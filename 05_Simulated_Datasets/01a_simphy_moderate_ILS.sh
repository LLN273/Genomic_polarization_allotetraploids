...
# Case A: moderate ILS, recent speciation, 16 taxa
b=0.000001
OUTF=A_modILS_recSpeciation_16t
ntaxa=16

# case B: moderate ILS, deep speciation, 16 taxa
#b=0.0000001
#OUTF=B_modILS_deepSpeciation_16t
#ntaxa=16
