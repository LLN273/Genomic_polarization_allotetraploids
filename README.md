...
Input arguments:
- <input.fasta>
  MSA in fasta format. Sequences are assumed to be aligned and coded using IUPAC nomenclature. 
...
- <refSequence ID>
  Reference sequence ID (polarizing sequence), as shown in MSA.
  
- <polyploid ID>
  Allopolyploid sequence ID, as shown in MSA.
